...
- **SPA-safe download trigger** — download clicks no longer bubble to the page, preventing manga readers and image viewers from jumping back to page 1
...
- **SPA 安全下載觸發** — 下載用的假 click 不再向上 bubble，防止漫畫閱讀器或圖片瀏覽器跳回第一頁
